...
const vendor: VendorConfig = {
  ...
  author: "Toonflow",
  name: "openrouter标准接口",
  description: "openrouter标准格式接口，可修改请求地址并手动添加模型。",
  inputs: [
  ...
  models: [
    { name: "openrouter/free", modelName: "openrouter/free", type: "text", think: false },
    { name: "minimax/minimax-m3:free", modelName: "minimax/minimax-m3:free", type: "text", think: false }
  ],
};
